  ...
  app: {
    head: {
      ...
      meta: [
        ...
        { property: 'og:url', content: 'https://www.gp-elec.fr/' },
        { property: 'og:image', content: `https://www.gp-elec.fr${config.seo.ogImage}` },
        ...
        { name: 'twitter:image', content: `https://www.gp-elec.fr${config.seo.ogImage}` },
      ],
      link: [
        ...
        { rel: 'alternate', hreflang: 'fr-FR', href: 'https://www.gp-elec.fr/' },
